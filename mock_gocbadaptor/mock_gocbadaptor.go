...
func (_m *MockCouchBaseAdaptor) Get(key string) (gocb.Cas, []byte, error) {
...
func (_m *MockCouchBaseAdaptor) Insert(key string, data []byte) (gocb.Cas, error) {
...
func (_m *MockCouchBaseAdaptor) Upsert(key string, data []byte) (gocb.Cas, error) {
